...
from core.bandits.algorithms.bootstrapped_bnn_sampling import BootstrappedBNNSampling
from core.bandits.core.contextual_bandit import run_contextual_bandit
from core.bandits.data.data_sampler import sample_adult_data
from core.bandits.data.data_sampler import sample_census_data
from core.bandits.data.data_sampler import sample_covertype_data
from core.bandits.data.data_sampler import sample_jester_data
from core.bandits.data.data_sampler import sample_mushroom_data
from core.bandits.data.data_sampler import sample_statlog_data
from core.bandits.data.data_sampler import sample_stock_data
from core.bandits.algorithms.fixed_policy_sampling import FixedPolicySampling
from core.bandits.algorithms.linear_full_posterior_sampling import LinearFullPosteriorSampling
from core.bandits.algorithms.neural_linear_sampling import NeuralLinearPosteriorSampling
from core.bandits.algorithms.parameter_noise_sampling import ParameterNoiseSampling
from core.bandits.algorithms.posterior_bnn_sampling import PosteriorBNNSampling
from core.bandits.data.synthetic_data_sampler import sample_linear_data
from core.bandits.data.synthetic_data_sampler import sample_sparse_linear_data
from core.bandits.data.synthetic_data_sampler import sample_wheel_bandit_data
from core.bandits.algorithms.uniform_sampling import UniformSampling

# Set up your file routes to the data files.
base_route = os.getcwd()
data_route = 'data/contextual_bandits/datasets'

FLAGS = flags.FLAGS
FLAGS.set_default('alsologtostderr', True)
flags.DEFINE_string('data_type', 'mushroom', 'data_type to use')
flags.DEFINE_string('logdir', 'results/', 'Base directory to save output')
flags.DEFINE_string(
    'mushroom_data',
...
flags.DEFINE_string('n_adv', '10', 'number of adversarial points')
...
def main(_):
  ...
  data_type = FLAGS.data_type #'mushroom'
  ...
  hparams_bbb_1 = tf.contrib.training.HParams(num_actions=num_actions,
                                            context_dim=context_dim,
                                            init_scale=0.3,
                                            activation=tf.nn.relu,
                                            layer_sizes=[50],
  ...
  hparams_bbb_2 = tf.contrib.training.HParams(num_actions=num_actions,
                                            context_dim=context_dim,
                                            init_scale=0.3,
                                            activation=tf.nn.relu,
                                            layer_sizes=[500],
  ...
  LAYER_SIZES= [[50], [50, 50], [50, 50, 50], [500], [500, 500], [500, 500, 500]]
  hparams_fbnn_s = [tf.contrib.training.HParams(num_actions=num_actions,
                                            context_dim=context_dim,
                                            init_scale=0.3,
                                            activation=tf.nn.relu,
                                            ...
                                            training_freq=50,
                                            training_epochs=100,
                                            n_adv=int(FLAGS.n_adv),
                                            n_sample=100,
                                            hparams_gp=hparams_gp) for layer_sizes in LAYER_SIZES]
  ...
  algos = [
      ...
      PosteriorBNNSampling('BBB_50', hparams_bbb_1, 'Variational'),
      PosteriorBNNSampling('BBB_500', hparams_bbb_2, 'Variational'),
  ...
  algos = algos + [PosteriorBNNSampling('FBNN'+str(ls), hp, 'FBNN') for ls, hp in zip(LAYER_SIZES, hparams_fbnn_s)]
